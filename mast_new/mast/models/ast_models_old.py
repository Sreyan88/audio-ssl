...
class ASTModel(nn.Module):
    ...
    """
    def __init__(self, mvit_cfg, label_dim=527, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='mvit', verbose=True):
        ...
        if audioset_pretrain == False:
            ...
            self.mlp_head = nn.Sequential(nn.LayerNorm(6144), nn.Linear(6144, label_dim))
