...
def main(args):
    ...
    dm = BaselineDataModule(args, tfms, train_data_dir_list = list_of_files_directory,num_workers=16,batch_size=args.batch_size) 
...
def get_args():
    ...
    # Add data arguments
    parser.add_argument("--input", default='/nlsasfs/home/nltm-pilot/ashishs/pretrain_shuffled_final.csv', help="path to data directory", type=str)
    ...
    parser.add_argument("--save-path", help="path to saving model directory", type=str, default="/nlsasfs/home/nltm-pilot/ashishs/DeloresM/upstream_Delores-mvit_moco_v3_pretrained/checkpoint_byol_exp_1_batch_1024_cc_changed_128_cluster_new_new_nl_kmix_1024")
