...
class AAAI_BARLOW(nn.Module):
    ...
    def __init__(self,args):
        ...
        self.projector = nn.Sequential(nn.Dropout(0.5),nn.Linear(1280, self.units, bias=False),nn.BatchNorm1d(self.units),nn.ReLU(),nn.Linear(self.units, self.units, bias=False),nn.BatchNorm1d(self.units),nn.ReLU(),nn.Linear(self.units, self.units, bias = False))
