...
def get_args():
    ...
    # Add data arguments
    parser.add_argument("--input", help="path to data directory", type=str, default='/nlsasfs/home/nltm-pilot/ashishs/pretrain_shuffled_short.csv')
    ...
    parser.add_argument('--model_type', type=str, help='define model type', default = 'deloress')
    # Add model arguments
