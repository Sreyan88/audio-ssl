...
class SpeechCommandsV1Train(Dataset):
    def __init__(self,tfms=None,sample_rate=16000):                
        self.feat_root = "/nlsasfs/home/nltm-pilot/ashishs/scv1/spec_byol_scv1_test"
        self.uttr_labels= pd.read_csv("/nlsasfs/home/nltm-pilot/sandeshk/icassp/data/speechv1/train/"+"train_data.csv")
...
class SpeechCommandsV1Test(Dataset):
    def __init__(self,tfms=None,sample_rate=16000):        
        self.feat_root = "/nlsasfs/home/nltm-pilot/ashishs/scv1/spec_byol_scv1_test"
        self.uttr_labels= pd.read_csv("/nlsasfs/home/nltm-pilot/sandeshk/icassp/data/speechv1/train/"+"test_data.csv")
        self.sample_rate = sample_rate
        self.labels_dict = {'unknown': 0, 'down': 1, 'go': 2, 'silence': 3, 'on': 4, 'stop': 5, 'left': 6, 'no': 7,'up': 8, 'yes': 9, 'off': 10, 'right': 11}
        self.no_of_classes= len(self.labels_dict)
        self.to_mel_spec = MelSpectrogramLibrosa()
