...
from utils_downstream import (AverageMeter,Metric,freeze_effnet,freeze_byol,get_downstream_parser,load_pretrain_effnet,load_pretrain_byol,calc_norm_stats) #resume_from_checkpoint, save_to_checkpoint,set_seed
...
def main_worker(gpu, args):
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,batch_size=per_device_batch_size,
                                                pin_memory=True,sampler = train_sampler, num_workers=16)
