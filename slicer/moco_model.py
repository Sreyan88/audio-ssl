...
criterion_cluster = contrastive_loss.ClusterLoss(128, 1, None)
...
class Moco_v2(pl.LightningModule):
    ...
    def init_encoders(self, base_encoder):
        ...
        """
        encoder_q = AudioNTT2020Task6(self.hparams.emb_dim, 128, 64, 2048)
        encoder_k = AudioNTT2020Task6(self.hparams.emb_dim, 128, 64, 2048)
...
#         dequeue and enqueue
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.trainer.current_epoch % 2 == 0:
            ...
            output_1, target_1, q_cluster,q1,q2,q3, k_cluster,k1,k2,k3 = self(img_q=img_2, img_k=img_1)
            ...
            #loss_cluster_1 = self.loss_cluster(q_cluster_1, k_cluster_1)
            #loss_cluster = (loss_cluster_0 + loss_cluster_1)/2
